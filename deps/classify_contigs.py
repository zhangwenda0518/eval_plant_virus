...
Usage:
  python classify_contigs.py -i final_integrated_classification.tsv -f sequences.fasta
  python classify_contigs.py -i ACVirus_results/step4_classification_eval.acvirus/final_result.tsv -f contigs.fasta -o classified/
"""
import polars as pl
